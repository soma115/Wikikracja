...
3. **Wspólne komponenty przed lokalnymi wyjątkami.** Najpierw używamy istniejących wzorców: `tw-btn`, `tw-card`, `tw-toolbar`, `tw-form-*`, `tw-modal`, `tw-dropdown`, `tw-alert`, `tw-proposals-list` i wspólnych partiali.
