...
module.exports = {
  ...
  safelist: [
    ...
    'tw-card--no-hover', 'tw-hr-subtle', 'tw-tile-text-muted', 'tw-balance-positive', 'tw-balance-negative', 'tw-activity-pulse', 'tw-activity-pulse-ring', 'tw-activity-pulse-value', 'tw-activity-pulse-bar', 'tw-activity-pulse-segment', 'tw-activity-pulse-segment--green', 'tw-activity-pulse-segment--yellow', 'tw-activity-pulse-segment--muted',
    'tw-cursor-default',
    ...
    'tw-section', 'tw-toolbar', 'tw-toolbar-divider', 'tw-toolbar-sort', 'tw-responsive-hide-inactive', 'tw-responsive-hide-labels', 'tw-responsive-wrap', 'tw-auto-collapsed', 'tw-sort-btn', 'tw-sort-btn--off', 'tw-sort-btn-label', 'tw-sort-arrow', 'tw-sort-arrow--off', 'tw-toolbar-sort-sep', 'tw-toolbar-view', 'tw-view-toggle-btn', 'tw-view-label', 'tw-btn-cta', 'tw-btn-cta--round', 'tw-btn-cta-label', 'tw-chat-count', 'tw-chat-count--section',
    ...
    'tw-citizens-toolbar', 'tw-citizens-search-input', 'tw-citizens-filter-btn', 'tw-filter-label', 'tw-citizens-table-wrap', 'tw-citizens-table', 'tw-table-sm', 'tw-table-hover', 'tw-user-row', 'tw-citizens-grid', 'tw-citizen-card', 'tw-citizen-card-top', 'tw-avatar-presence', 'tw-presence-dot', 'tw-presence-green', 'tw-presence-yellow', 'tw-presence-red', 'tw-near-threshold', 'tw-status-dot', 'tw-status-dot--online', 'tw-status-dot--active', 'tw-status-dot--dormant', 'tw-status-dot--inactive', 'tw-hidden-mobile', 'tw-hidden-tablet', 'tw-hidden-desktop', 'tw-restart-count', 'tw-candidate-vote-badge', 'tw-width-30', 'tw-min-w-20', 'tw-min-w-12', 'tw-max-w-640', 'tw-avatar-upload-wrap', 'tw-avatar-overlay', 'tw-avatar-overlay-icon', 'tw-profile-name', 'tw-profile-email', 'tw-profile-row', 'tw-profile-key', 'tw-profile-val', 'tw-historia-badge', 'tw-historia-current-badge', 'tw-historia-meta', 'tw-diff-block', 'tw-border-approved', 'tw-proposals-list', 'tw-content-card', 'tw-content-card-header', 'tw-content-card-title-row', 'tw-content-card-title', 'tw-content-card-meta', 'tw-content-card-body', 'tw-empty-state', 'tw-empty-state-title',
    ...
    'tw-toast', 'tw-toast--visible', 'tw-chat-has-messages',
    ...
    'tox-tinymce', 'tox-editor-header', 'tox-toolbar', 'tox-toolbar__primary', 'tox-tbtn', 'tox-tbtn--enabled', 'tw-chat-room-pulse',
