...
- **Scheduler:** `zzz/scheduler.py` uruchamia zadania cykliczne (chat_messages, chat_rooms, głosowania, count_citizens, update_site, powiadomienia o wydarzeniach). Używa `SCHEDULER_LOCK_FILE`.
