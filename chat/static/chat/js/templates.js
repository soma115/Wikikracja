...
<div id='room'>
  ...
  <div class="tw-chat-breadcrumb-row">
    ...
    <div class="tw-chat-sort-toolbar" id="chat-sort-toolbar" data-responsive-controls role="toolbar" aria-label="${_("Sorting and filter")}">
      <button type="button" class="tw-sort-btn tw-sort-btn--off" id="chat-sort-likes" data-sort="likes" data-order="none" data-sort-state="none" aria-pressed="false" aria-label="${_("Likes")}" title="${_("Likes")}">
