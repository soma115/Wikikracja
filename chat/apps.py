...
class ChatConfig(AppConfig):
    ...
    def ready(self):
        ...
        from .dashboard import get_group_settings_context
        ...
        register_dashboard_provider('chat', get_context=get_dashboard_context, get_group_settings_context=get_group_settings_context)
